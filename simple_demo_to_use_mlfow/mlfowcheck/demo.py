...
dagshub.init(repo_owner='btirkey', repo_name='mlflow_tuts', mlflow=True)
...
#  Set Dagshub MLflow URI before starting the run
remote_server_uri = "https://dagshub.com/btirkey/mlflow_tuts.mlflow"
